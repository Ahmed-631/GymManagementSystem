        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhone", " Phone Like    '01[1205][0-9]{8}'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("DurationDayCheck", "DurationDays between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhone1", " Phone Like    '01[1205][0-9]{8}'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sessiones", x => x.Id);
                    table.CheckConstraint("SessonCapacityCheck", "Capacity  between 1 and 25");
                    table.CheckConstraint("SessonEndDateCheck", "  EndDate > StartDate");
                    table.ForeignKey(
                        name: "FK_Sessiones_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sessiones_Trainers_TrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberSessions_Sessiones_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessiones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessiones_CategoryId",
                table: "Sessiones",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Sessiones_TrainerId",
                table: "Sessiones",
                column: "TrainerId");
